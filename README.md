...
A collection of 13 Jupyter notebooks for learning Python through short examples, exercises, and interactive demos. Topics include basic syntax, strings, collections, Boolean values, comparison operators, and file handling.
